...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (banner) {
    function toggleParallaxClass() {
      if (window.innerWidth > 900) {
        banner.classList.add('parallax-animated');
      } else {
        banner.classList.remove('parallax-animated');
      }
    }

    window.addEventListener('resize', toggleParallaxClass);
    toggleParallaxClass();
  }
});
